# print('auth', __name__, __file__)
from flask import Blueprint, render_template, request, redirect, url_for, flash
# print('bbzzzz')
from kekauth.data import Users, UsersInfo
...
def signup():
    if request.method == 'POST':
        ...
        if user:
            ...
            new_user_info = UsersInfo(first_name=first_name, second_name=second_name, user_id=current_user.id)
